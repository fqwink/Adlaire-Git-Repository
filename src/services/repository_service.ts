...
export class RepositoryService {
  ...
  async listTree(
    ...
    const repository = await this.requireVisibleRepository(owner, name, actor);
    return await this.git.listTree(
      repository.owner,
      repository.name,
      ref,
      path,
  ...
  async readFile(
    ...
    const repository = await this.requireVisibleRepository(owner, name, actor);
    return await this.git.readFile(
      repository.owner,
      repository.name,
      path,
      ref,
  ...
  async updateVisibility(
    ...
    const updated = await this.repositoryRepository.updateVisibility(
      repository.owner,
      repository.name,
      visibility,
  ...
  async requireVisibleRepository(
    ...
    const repository = await this.repositoryRepository.find(
      safeOwner,
      safeName,
    );
    if (repository === null) {
