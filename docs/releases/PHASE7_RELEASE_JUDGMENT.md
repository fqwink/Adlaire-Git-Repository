...
本書は、Phase 7 のデフォルト安定版リリース判定に必要な材料を整理するための文書である。

本書は、安定版リリースそのもの、tag 作成、GitHub Releases 作成、成果物配置、release notes 公開、`v.1.8` への移行を承認する文書ではない。

初回安定版リリース判定、安定版としての公開判断、`v.1.8` への移行、tag 作成、GitHub Releases 作成、成果物配置、release notes 公開は、別途リリース提案を提示し、ユーザー承認を得てから行う。
...
Phase 7 の安定版リリース判定を行う場合は、以下を別途提示し、ユーザー承認を得る。
