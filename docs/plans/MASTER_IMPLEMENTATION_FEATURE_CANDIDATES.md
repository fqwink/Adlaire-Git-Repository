...
| v.0.38 | Phase 11 の3類マスター仕様改善に合わせ、本体公開契約、SDK client lifecycle、SDK 互換性方針、履歴と現行正本仕様の読み分け強化を候補整理へ反映 |
...
| v.0.43 | Adlaire Portal System のバージョンポリシーを `v.` 表記維持で適用し、開発版 `v.0.N` と安定版 `v.X.Y` を分離する方針へ整合 |
