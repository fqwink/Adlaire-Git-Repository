...
| Phase 11 | v.2.10 | 着手 | Go 移行準備。固定採用バージョン、実装構成、検証導線、旧 Deno + TypeScript 資産、ヘッドレスアーキテクチャ方針、SDK の TypeScript 実装 / JavaScript 生成方針、Docker の Adlaire Pipeline 経由方針を整理 |
