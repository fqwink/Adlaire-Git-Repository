...
| Phase 2 | v.2.3 | 未着手 | Pull Request、Issue、Wiki、Webhook、開発支援機能。WYSIWYG エディター実装時期は未定 |
...
1. Phase 2 仕様差分の確定
2. 権限モデルと監査ログ対象の整理
3. Pull Request / Code Review の最小単位
4. Issue / Wiki の最小単位
5. Webhook / REST API 基本機能
6. Release 管理、Star / Watch
7. 意味のあるテストと主要検証
